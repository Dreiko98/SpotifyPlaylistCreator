...
def chooseArtists(artistsDic, sp): # devuelve chosenArtists, una lista con los ids de los artistas elegidos
    chosenArtists = []
    while True:
...
def createPlaylist(dicParameters, sp, playlistOriginal):
    ...
    new_playlist = sp.user_playlist_create(user=user_id, name=playlist_name, public=playlist_public, description=playlist_description)
